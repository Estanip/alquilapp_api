...
import { IUser, TUserEmail, TUserLoginResponse } from '../interfaces/User';
import {
    CREATED,
    FORBIDDEN,
...
export class AuthController {
    ...
    login = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const user: IUser = await this._findUser(email);
    ...
    _findUser = (email: TUserEmail) => User.findOne({ email }).exec();
}
